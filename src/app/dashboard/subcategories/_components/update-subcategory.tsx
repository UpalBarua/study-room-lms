...
import { updateSubcategoryAction } from "@/actions/subcategories-actions";
...
type UpdateSubategoryProps = {
  currentSubcategory: Subcategory;
};

export function UpdateSubcategory({
  currentSubcategory,
}: Readonly<UpdateSubategoryProps>) {
  ...
  useEffect(() => {
    form.reset({
      ...
      name_en: currentSubcategory.name_en,
      course_category_id: currentSubcategory.course_category_id,
      icon: "",
    });
    setPreview(`${photos}/${currentSubcategory.icon}`);
  }, [currentSubcategory, form]);

  function onSubmit(data: SubcategoryFormSchema) {
    startTransition(async () => {
      const response = await updateSubcategoryAction({
        ...data,
        uuid: currentSubcategory.uuid,
      });
