...
import { addDeaprtmentAction } from "@/actions/department-actions";
...
export function AddDepartment({ levels }: Readonly<AddDepartmentProps>) {
  ...
  function onSubmit(data: DepartmentFormSchema) {
    startTransition(async () => {
      const response = await addDeaprtmentAction(data);
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add new department here. Click add when you're done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
